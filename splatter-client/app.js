(function() { // We use this anonymous function to create a closure.
	...
	{
		return $resource('http://hayes.sqrawler.com/api/users/:id.json',{},{
		update: {method:'PUT'},
		follow: {method:'POST', url:'http://hayes.sqrawler.com/api/users/follows/'},
		addsplatt: {method:'POST', url:'http://hayes.sqrawler.com/api/splatts/'},
		unfollow: {method:'DELETE', url:'http://hayes.sqrawler.com/api/users/follows/:id/:follows_id'}})
	});
	
	app.factory('SplattsFeed', function($resource) 
	{
		return $resource('http://hayes.sqrawler.com/api/users/splatts-feed/:id.json',{},{
		getsplatts: {method:'GET',url:'http://hayes.sqrawler.com/api/users/splatts/:id.json', isArray:true}});
	});
